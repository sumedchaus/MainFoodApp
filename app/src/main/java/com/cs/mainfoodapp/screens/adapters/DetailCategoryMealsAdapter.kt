...
import com.cs.mainfoodapp.databinding.MealItemBinding

class DetailCategoryMealsAdapter :
    RecyclerView.Adapter<DetailCategoryMealsAdapter.CategoryMealsViewModel>() {
